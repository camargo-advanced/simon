...
#define PIN_LED_BLUE        GPIO5  /* GPIOA->GPIO05 = LED WHITE   */
...
#define PIN_PUSHB_BLUE      GPIO7  /* GPIOB->GPIO07 = PUSH WHITE  */
#define EXTI_PUSHB_BLUE     EXTI7  /* isr for white push button */
